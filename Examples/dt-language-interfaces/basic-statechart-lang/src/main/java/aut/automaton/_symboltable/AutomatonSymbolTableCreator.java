...
public class AutomatonSymbolTableCreator extends AutomatonSymbolTableCreatorTOP{
    public AutomatonSymbolTableCreator(ResolvingConfiguration resolvingConfig, MutableScope enclosingScope) {
    ...
    public void visit(ASTBehaviorDefinitionCompilationUnit node) {
        ...
        ArtifactScope artifactScope = new AutomatonArtifactScope(compilationUnitPackage, imports);
