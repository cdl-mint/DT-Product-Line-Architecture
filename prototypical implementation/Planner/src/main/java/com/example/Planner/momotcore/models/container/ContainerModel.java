 ...
 * </p>
 * <ul>
 *   <li>{@link ContainerModel#getStack <em>Stack</em>}</li>
 *   <li>{@link ContainerModel#getNextContainer <em>Next Container</em>}</li>
 *   <li>{@link ContainerModel#getContainer <em>Container</em>}</li>
 * </ul>
 *
 * @see ContainerPackage#getContainerModel()
 * @model
 * @generated
 */
public interface ContainerModel extends EObject {
    ...
    * @see ContainerPackage#getContainerModel_Stack()
    ...
    * @see ContainerPackage#getContainerModel_NextContainer()
    * @model
    * @generated
    */
   ...
   /**
    * Sets the value of the '{@link ContainerModel#getNextContainer <em>Next Container</em>}' reference.
    * <!-- begin-user-doc -->
    * <!-- end-user-doc -->
    ...
    * The list contents are of type {@link Container}.
    * <!-- begin-user-doc -->
    * <!-- end-user-doc -->
    * @return the value of the '<em>Container</em>' containment reference list.
    * @see ContainerPackage#getContainerModel_Container()
    * @model containment="true" required="true"
    * @generated
    */
