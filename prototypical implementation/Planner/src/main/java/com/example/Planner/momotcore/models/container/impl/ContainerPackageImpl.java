...
import com.example.Planner.momotcore.models.container.ContainerFactory;
...
public class ContainerPackageImpl extends EPackageImpl implements ContainerPackage {
   ...
   public void initializePackageContents() {
      ...
      initEClass(containerEClass, com.example.Planner.momotcore.models.container.Container.class, "Container", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
      initEAttribute(getContainer_Id(), ecorePackage.getEString(), "id", null, 0, 1, com.example.Planner.momotcore.models.container.Container.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
      initEReference(getContainer_OnTopOf(), this.getContainer(), null, "onTopOf", null, 0, 1, com.example.Planner.momotcore.models.container.Container.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
      initEReference(getContainer_Successor(), this.getContainer(), null, "successor", null, 0, 1, com.example.Planner.momotcore.models.container.Container.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
      initEReference(getContainer_On(), this.getStack(), null, "on", null, 0, 1, com.example.Planner.momotcore.models.container.Container.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
