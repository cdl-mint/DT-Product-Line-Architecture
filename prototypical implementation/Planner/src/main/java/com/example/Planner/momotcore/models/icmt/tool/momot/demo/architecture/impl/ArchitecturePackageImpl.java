/**
 */
package com.example.Planner.momotcore.models.icmt.tool.momot.demo.architecture.impl;

import com.example.Planner.momotcore.models.icmt.tool.momot.demo.architecture.Class;
...
import com.example.Planner.momotcore.models.icmt.tool.momot.demo.architecture.ArchitectureFactory;
import com.example.Planner.momotcore.models.icmt.tool.momot.demo.architecture.ArchitecturePackage;
import com.example.Planner.momotcore.models.icmt.tool.momot.demo.architecture.Attribute;
import com.example.Planner.momotcore.models.icmt.tool.momot.demo.architecture.ClassModel;
import com.example.Planner.momotcore.models.icmt.tool.momot.demo.architecture.Feature;
import com.example.Planner.momotcore.models.icmt.tool.momot.demo.architecture.Method;
import com.example.Planner.momotcore.models.icmt.tool.momot.demo.architecture.NamedElement;
...
public class ArchitecturePackageImpl extends EPackageImpl implements ArchitecturePackage {
    ...
    * @see ArchitecturePackage#eNS_URI
    * @see #init()
    * @generated
    */
   ...
   public void initializePackageContents() {
      ...
      initEReference(getClass_Encapsulates(), this.getFeature(), this.getFeature_IsEncapsulatedBy(), "encapsulates",
            null, 1, -1, Class.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE,
