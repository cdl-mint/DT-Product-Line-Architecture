...
public abstract class FeatureImpl extends NamedElementImpl implements Feature {
    ...
    * @ordered
    */
   protected Class isEncapsulatedBy;
    ...
    * @generated
    */
   public Class basicGetIsEncapsulatedBy() {
    ...
    * @generated
    */
   public NotificationChain basicSetIsEncapsulatedBy(final Class newIsEncapsulatedBy,
         NotificationChain msgs) {
      final Class oldIsEncapsulatedBy = isEncapsulatedBy;
   ...
   public NotificationChain eInverseAdd(final InternalEObject otherEnd, final int featureID, NotificationChain msgs) {
      switch(featureID) {
         case ArchitecturePackage.FEATURE__IS_ENCAPSULATED_BY:
            ...
            return basicSetIsEncapsulatedBy((Class) otherEnd, msgs);
      }
   ...
   public void eSet(final int featureID, final Object newValue) {
      switch(featureID) {
         case ArchitecturePackage.FEATURE__IS_ENCAPSULATED_BY:
            setIsEncapsulatedBy((Class) newValue);
            return;
      }
   ...
   public void eUnset(final int featureID) {
      switch(featureID) {
         case ArchitecturePackage.FEATURE__IS_ENCAPSULATED_BY:
            setIsEncapsulatedBy((Class) null);
            return;
      }
   ...
   public Class getIsEncapsulatedBy() {
      if(isEncapsulatedBy != null && isEncapsulatedBy.eIsProxy()) {
         ...
         isEncapsulatedBy = (Class) eResolveProxy(oldIsEncapsulatedBy);
    ...
    */
   @Override
   public void setIsEncapsulatedBy(final Class newIsEncapsulatedBy) {
