/**
 */
package com.example.Planner.momotcore.models.at.ac.tuwien.big.momot.examples.stack.stack.util;
...
public class StackAdapterFactory extends AdapterFactoryImpl {
   ...
   /**
    * Creates a new adapter for an object of class '{@link Stack
    * <em>Stack</em>}'.
    * <!-- begin-user-doc -->
   ...
   /**
    * Creates a new adapter for an object of class '{@link StackModel
    * <em>Model</em>}'.
    * <!-- begin-user-doc -->
    * This default implementation returns null so that we can easily ignore cases;
    * it's useful to ignore a case when inheritance will catch all the cases anyway.
