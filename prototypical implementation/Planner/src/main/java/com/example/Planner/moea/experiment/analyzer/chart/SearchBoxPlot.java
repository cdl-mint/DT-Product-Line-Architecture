package com.example.Planner.moea.experiment.analyzer.chart;
...
public final class SearchBoxPlot {
   ...
   protected static final Key WIDTH_HINT = new Key(03172) {
      @Override
   ...
   protected static final Key HEIGHT_HINT = new Key(03173) {
      @Override
      public boolean isCompatibleValue(final Object val) {
         return CastUtil.asClass(val, Integer.class) != null;
      }
