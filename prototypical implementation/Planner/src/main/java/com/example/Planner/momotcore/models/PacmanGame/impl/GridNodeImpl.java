 ...
 * </p>
 * <ul>
 *   <li>{@link GridNodeImpl#getTop <em>Top</em>}</li>
 *   <li>{@link GridNodeImpl#getBottom <em>Bottom</em>}</li>
 *   <li>{@link GridNodeImpl#getLeft <em>Left</em>}</li>
 *   <li>{@link GridNodeImpl#getRight <em>Right</em>}</li>
 *   <li>{@link GridNodeImpl#getId <em>Id</em>}</li>
 * </ul>
 *
 * @generated
 */
