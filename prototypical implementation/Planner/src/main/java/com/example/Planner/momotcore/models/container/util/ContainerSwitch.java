...
public class ContainerSwitch<T> extends Switch<T> {
   ...
   protected T doSwitch(int classifierID, EObject theEObject) {
      switch (classifierID) {
         case ContainerPackage.CONTAINER_MODEL: {
            ContainerModel containerModel = (ContainerModel)theEObject;
            T result = caseContainerModel(containerModel);
            if (result == null) result = defaultCase(theEObject);
            return result;
         }
         case ContainerPackage.STACK: {
    ...
    * @generated
    */
   public T caseContainerModel(ContainerModel object) {
      return null;
   }
