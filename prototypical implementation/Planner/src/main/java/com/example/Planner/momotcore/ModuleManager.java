...
import com.example.Planner.momotcore.problem.solution.variable.RuleApplicationVariable;
import com.example.Planner.momotcore.problem.unit.parameter.IParameterValue;
import com.example.Planner.momotcore.problem.unit.parameter.increment.IncrementalStringValue;
import com.example.Planner.momotcore.problem.unit.parameter.random.RandomDoubleValue;
...
public class ModuleManager {
   ...
   public Map<String, Unit> getNameToUnits() {
      return nameToUnits;
   }
   ...
   public Unit getUnitFromAll(final String qualifiedUnitName) {
      return allUnits.get(getQualifiedName(qualifiedUnitName));
   }
   ...
   protected void initUnits(final Module module) {
      ...
      for(final Unit unit : module.getUnits()) {
         ...
         allUnits.put(getQualifiedName(unit), unit);
