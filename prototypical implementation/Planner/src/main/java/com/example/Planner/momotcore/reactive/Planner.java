...
import com.example.Planner.momotcore.reactive.planningstrategy.PredictiveReplanningStrategy;
...
import com.example.Planner.momotcore.reactive.result.ReactiveRunResult;
import com.example.Planner.momotcore.reactive.result.SearchResult;
import com.example.Planner.momotcore.reactive.result.SolutionAnalyzer;
import com.example.Planner.momotcore.search.criterion.ThresholdCondition;
import com.example.Planner.momotcore.search.criterion.TimedObjectiveCondition;
...
public class Planner {
   ...
   private TerminationCondition createTerminationConditionForPredictiveReplanningType(
           final PredictiveReplanningStrategy.PredictiveReplanningType type, final EGraph idleComputedResultGraph) {
      switch(type) {
         case TERMINATE_AFTER_TIME_IF_OBJECTIVE_SATISFIED:
