...
public class StackPackageImpl extends EPackageImpl implements StackPackage {
   ...
   public static StackPackage init() {
      if(isInited) {
         return (StackPackage) Registry.INSTANCE.getEPackage(StackPackage.eNS_URI);
      }

      // Obtain or create and register package
      final StackPackageImpl theStackPackage = (StackPackageImpl) (Registry.INSTANCE
            .get(eNS_URI) instanceof StackPackageImpl ? Registry.INSTANCE.get(eNS_URI)
      ...
      Registry.INSTANCE.put(StackPackage.eNS_URI, theStackPackage);
