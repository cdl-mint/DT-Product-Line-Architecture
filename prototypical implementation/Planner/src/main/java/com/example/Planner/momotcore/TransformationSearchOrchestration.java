 ...
 *******************************************************************************/
package com.example.Planner.momotcore;

import com.example.Planner.moea.AbstractSearchOrchestration;
...
import com.example.Planner.momotcore.print.ITransformationSolutionPrinter;
import com.example.Planner.momotcore.print.TransformationSolutionWriter;
import com.example.Planner.momotcore.problem.TransformationProblem;
import com.example.Planner.momotcore.problem.solution.TransformationSolution;
import com.example.Planner.momotcore.problem.unit.parameter.comparator.IEObjectEqualityHelper;
import com.example.Planner.momotcore.search.algorithm.reinforcement.environment.SolutionProvider;
import com.example.Planner.momotcore.search.engine.MomotEngine;
import com.example.Planner.momotcore.search.fitness.EGraphMultiDimensionalFitnessFunction;
...
import com.example.Planner.momotcore.search.solution.generator.TransformationSolutionGenerator;
...
public class TransformationSearchOrchestration extends AbstractSearchOrchestration<TransformationSolution> {
   ...
   public TransformationSearchOrchestration() {
      ...
      this.solutionExtender = new SolutionProvider<>(this.getSearchHelper());
   }
