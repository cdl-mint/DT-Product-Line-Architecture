package com.example.Planner.momotcore.problem.solution.variable;
...
public class UnitApplicationVariable extends UnitApplicationImpl implements IUnitApplicationVariable {
   ...
   public UnitApplicationVariable(final ITransformationVariable variable) {
      ...
      // this.appliedRules.addAll(((UnitApplicationVariable) variable).getAppliedRules());
      // this.undoneRules.addAll(((UnitApplicationVariable) variable).getUndoneRules());
      // }
   }
   ...
   public String toString() {
      String s = getAssignment().toString();
      if(!this.getAppliedRules().isEmpty()) {
         for(final RuleApplication r : this.getAppliedRules()) {
            s += "\t" + r.getPartialMatch();
         }
      }
      return s;
