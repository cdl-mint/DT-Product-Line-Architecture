 ...
 * </p>
 * <ul>
 * <li>{@link Entity#getOwnedAttribute <em>Owned
 * Attribute</em>}</li>
 * <li>{@link Entity#getSpecialization
 * <em>Specialization</em>}</li>
 * <li>{@link Entity#getGeneralization
 * <em>Generalization</em>}</li>
 * </ul>
 *
 * @see RefactoringPackage#getEntity()
 * @model
 * @generated
 */
public interface Entity extends NamedElement {
    ...
    * @see RefactoringPackage#getEntity_Generalization()
    ...
    * @see RefactoringPackage#getEntity_OwnedAttribute()
    * @model
    * @generated
    */
    ...
    * @see RefactoringPackage#getEntity_Specialization()
   ...
   /**
    * Sets the value of the '{@link Entity#getGeneralization
